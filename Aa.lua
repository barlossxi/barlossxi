...
local Window = Library.CreateLib(" ZA HUB RockFruit", "DarkTheme")

local Tab = Window:NewTab("General")

local Section = Tab:NewSection("Select Weapon")
...
Section:NewToggle("AutoFarm Monster [Fast]", "x", function(value)
   _G.AutoFarm = value 
end)
