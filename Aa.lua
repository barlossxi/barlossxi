...
local Mobile = PlusNero:Mobile("SOME X HUB",PlusNero.Themes.Original,Enum.KeyCode.RightControl)

local Return = {(nil)}

local Ultra = Mobile:Menu('Ultra')
local Tab = Mobile:Menu('Tab')


local Section = Ultra:Section('Monster)
...
Monster = {""}
local Monster = Ultra_left:Dropdown("Dropdown",Monster,function(value)
  Mob = value
end)

Ultra_left:Toggle("Toggle",false,function(value)
    _G.AutoFarm = value 
end)
