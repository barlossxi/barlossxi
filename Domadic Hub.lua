...
local Library = Update:Window("           Domadic","",Enum.KeyCode.RightControl);

local GA = Library:AddTab("Home","6026568198")
local GB = Library:AddTab("Level Farm","13075651575")
local GC = Library:AddTab("Auto Item Quest","13075622619")
local GD = Library:AddTab("Stats","7040410130")
local GS = Library:AddTab("RaceV4","11162889532")
local GG = Library:AddTab("Player","7251993295")
local GE = Library:AddTab("Raid","11155986081")
local GT = Library:AddTab("Teleport","11155851001")
local GH = Library:AddTab("Shop","6031265976")
local GF = Library:AddTab("Devil Fruit","7044233235")
local GZ = Library:AddTab("Misc","11156061121")
...
FrozenIsland = H:AddLabel("")
    ...
    GA:AddSeperator("Kitsunen")
        
    FaiFaoKai = GA:AddLabel("")
    
    
    GA:AddToggle("Teleport To Kitsunen Island",_G.AutoFKitsune,function(value)
    _G.AutoFKitsune = value
    StopTween(_G.AutoFKitsune)
    end)
    
    GA:AddToggle("Auto Azuer Ember",_G.AutoAzuerEmber,function(value)
    ...
    GA:AddToggle("Send Notification If Kitsunen Island Spwan",_G.KisuneWarn,function(value)
    _G.KisuneWarn = value
    end)
