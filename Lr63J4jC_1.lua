...
QuestLv = 1
NameMon = "Monkey"
CFrameQ = CFrame.new(-1599.951904296875, 36.977455139160156, 152.75381469726562)
CFrameMon = CFrame.new(-1643.7005615234375, 15.977422714233398, 70.9491958618164)
...
NameMon = "Gorilla"
CFrameQ = CFrame.new(-1599.951904296875, 36.977455139160156, 152.75381469726562)
CFrameMon = CFrame.new(-1203.0821533203125, 7.772562503814697, -445.515625)
...
NameMon = "Brute"
CFrameQ = CFrame.new(-1143.61474609375, 8.8773832321167, 3830.47607421875)
CFrameMon = CFrame.new(-1278.66162109375, 15.215201377868652, 4267.1904296875)
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(CF))
end
...
----------Tween
 ...
 function Tween(Pos)
        ...
        pcall(function() tween = game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart,TweenInfo.new(Distance/70, Enum.EasingStyle.Linear),{CFrame = Pos}) end)
        tween:Play()
...
--Create Tabs
    ...
    spawn(function()
        ...
        pcall(function()
          ...
          if (CFrameQ.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 1 then
          ...
          if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v.Position).Magnitude >= 1 then
...
Tabs.Main:AddParagraph({
    Title = "Misc Farm",
    Content = "โบน & คาตาคุริ & "
})

local ToggleBone = Tabs.Main:AddToggle("ToggleBone", {Title = "ออโต้ฟามโบน", Default = false })
...
local ToggleCake = Tabs.Main:AddToggle("ToggleCake", {Title = "ออโต้ตีคาตาคุริ", Default = false })
...
spawn(function()
	...
	local ToggleAutoFarmBoss = Tabs.Main:AddToggle("ToggleAutoFarmBoss", {Title = "ตีบอส", Default = false })
    ...
    local ToggleMaterial = Tabs.Main:AddToggle("ToggleMaterial", {Title = "ออโต้ฟามวัตถุดิบ", Default = false })
...
--------------------------------------------------------------------------------------------------------------------------------------------
--Stats
local ToggleMelee = Tabs.Stats:AddToggle("ToggleMelee", {Title = "อัพหมัด", Default = false })
...
local ToggleDe = Tabs.Stats:AddToggle("ToggleDe", {Title = "อัพเลือด", Default = false })
...
local ToggleSword = Tabs.Stats:AddToggle("ToggleSword", {Title = "อัพดาบ", Default = false })
...
local ToggleGun = Tabs.Stats:AddToggle("ToggleGun", {Title = "อัพปืน", Default = false })
...
local ToggleFruit = Tabs.Stats:AddToggle("ToggleFruit", {Title = "อัพผลปีศาจ", Default = false })
