...
Main:Seperator("  ออโต้ฟามคาตา ")
    ...
    Main:Toggle("Auto Farm Bone",_G.CakePrince,function(value)
	_G.CakePrince = value
end)
