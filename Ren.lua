...
function library:Window(text,text2,text3,logo,keybind)
	...
	MainPage.Size = UDim2.new(450, 300)
	...
	function uitab:Tab(text,logo1)
		...
		MainFramePage.Size = UDim2.new(450, 300)
...
_G.Color = Color3.fromRGB(3, 252, 231)
_G.ColorButton = Color3.fromRGB(3, 252, 86)
--Script
...
function CheckQuest() 
	...
	elseif World3 then
		...
		elseif MyLevel == 2400 or MyLevel <= 2425 or _G.Select_Mob_Farm == "Candy Pirate [Lv. 2400]" then
			...
			SPAWNPOINT = "Chocolate"
		elseif MyLevel >= 2425 or MyLevel <= 2449 _G.Select_Mob_Farm == "Snow Demon [Lv. 2425]" then
			Ms = "Snow Demon"
			NameQuest = "CandyQuest1"
			LevelQuest = 2
			NameMon = "Snow Demon"
			...
			SPAWNPOINT = "Chocolate"
			elseif MyLevel >= 2450 or MyLevel <= 2474 _G.Select_Mob_Farm == "Isle Outlaw [Lv. 2450]" then
			Ms = "Isle Outlaw"
			...
			SPAWNPOINT = "Chocolate"
			elseif MyLevel >= 2475 or MyLevel <= 2524 _G.Select_Mob_Farm == "Island Boy [Lv. 2475]" then
			Ms = "Island Boy"
			NameQuest = "TikiQuest1"
			LevelQuest = 2
			NameMon = "Island Boy"
