...
CamShake:Stop()
	...
	task.spawn(function()
        ...
        pcall(function()
          ...
          if not string.find(v.Name,"Boss") and v.Name == Mon and (v.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 350 then
