...
function Update:Window(text,logo,keybind)
    ...
    MapName.Text = "                 Blox Fruit Language Thai"
    MapName.TextColor3 = Color3.fromRGB(16, 232, 171)   
...
local LogoHub = Instance.new("ImageLabel")
    ...
    LogoHub.Image = "http://www.roblox.com/asset/?id="..tostring(l)
...
local LogoToggle = Instance.new("ImageLabel")
    ...
    LogoToggle.Image = "http://www.roblox.com/asset/?id="..tostring(l)
...
local Library = Update:Window("           ZOLA HUB","",Enum.KeyCode.RightControl);

local Main = Library:AddTab("เมนู","6026568198")
local Shop = Library:AddTab("อีเว้นทะเล","16387774287")
local M = Library:AddTab("ไอเท็ม","16387774287")
local Ss = Library:AddTab("อัพค่าพลัง","7040410130")
local Setting = Library:AddTab("ตั้งค่า","6034509993")
local Mlk = Library:AddTab("เกาะลับ","6026568198")
local RaceV4 = Library:AddTab("เผ่าวี4","11162889532")
local P = Library:AddTab("ผู้เล่น","7251993295")
local R = Library:AddTab("ลงดัน","7044284832")
local T = Library:AddTab("วาป","6035190846")
local S = Library:AddTab("ร้านค้า","6031265976")
local D = Library:AddTab("ผลปีศาจ","7044233235")
local Misc = Library:AddTab("อื่น","6034509993")
...
Misc:AddToggle("เชฟจุดเกิด Bypass",true,function(value)
    _G.Set = value
end)
...
Main:AddDropdown("เลือกอาวุธ",WeaponList,function(value)
...
FarmMode = "Normal"
Main:AddDropdown("โหมดฟาม", ListF,function(value)
    FarmMode = value
end)
    ...
    Main:AddToggle("ออโต้ฟาม",_G.AutoFarm,function(value)
        _G.AutoFarm = value
...
if World1 then
    Main:AddToggle("ออโต้ฟามเวล1-300ค่ตเร็วว",_G.AutoFarmFast,function(value)
        _G.Farmfast = value
...
Main:AddToggle("ซื้อดาบทั้งหมด",false,function(value)
       _G.AutoFarm = value
...
Main:AddDropdown("เลือกโหมด",tableMon,function(vu)
    _G.SelectMob = vu
end)
    
    Main:AddToggle("ออโต้ฟามม็อบ",_G.AutoFarmMob,function(value)
   ...
   Main:AddToggle("ออโต้ฟามจุดที่ใกล้ที่สุดด",_G.AutoFarmNearest,function(value)
...
Main:AddToggle("ออโต้ฟามกล่อง",false,function(value)
 AutoFarmChest = value
...
Main:AddToggle("ออโต้ฟามกล่องเกาะลับ",false,function(value)
...
Main:AddToggle("ออโต้ฟามกล่อง Bypass",false,function(vu)
	_G.ChestBypass = vu
end)
...
Main:AddDropdown("Select Cake Farm Mode", ListC,function(value)
    ...
    Main:AddToggle("ออโต้คาตาคุคิ",_G.AutoDoughtBoss,function(value)
...
spawn(function()
    ...
    Main:AddToggle("ออโต้กดเสกคาตาคุริ",true,function(value)
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner",value)
    end)
    
    Main:AddToggle("ออโต้ฟามคาตาคุริ v2", _G.Autodoughking,function(value)
         _G.Autodoughking = value
        StopTween( _G.Autodoughking)
    end)
    
    Main:AddToggle("ออโต้ฟามคาตาคุริ v2 ย้ายเชิฟ", _G.AutodoughkingHop,function(value)
...
for i, v in pairs(game:GetService("ReplicatedStorage"):GetChildren()) do
    ...
    Main:AddToggle("ออโต้ฟามบอสทั้งหมด",_G.AutoAllBoss,function(value)
        _G.AutoAllBoss = value
        StopTween(_G.AutoAllBoss)
    end)
    
    Main:AddToggle("ออโต้ฟามบอสทั้งหมดย้ายเชิฟ",_G.AutoAllBossHop,function(value)
...
Setting:AddToggle("By Pass Tp",BypassTP,function(Fast)
BypassTP = Fast
end)

    
Setting:AddToggle("รวมมอน",true,function(Mag)
    _G.BringMonster = Mag
    end)
    spawn(function()
        while task.wait() do
...
_G.BringMode = "Normal"
Setting:AddDropdown("เลือกโหมดรวมมอน", Bring,function(value)
    _G.BringMode = value
end)
spawn(function()
    while wait(.1) do
...
Setting:AddToggle("ออโต้ ฮาคิ",true,function(value)
_G.AUTOHAKI = value
end)
spawn(function()
    while wait(.1) do
    ...
    Setting:AddToggle("ออโต้ตีเร็ว",true,function(value)
        _G.FastAttack = value
    end)      
...
_G.FastMode = "Normal"Setting:AddDropdown("เลือกโหมดตีเร็ว",fast,function(value)
	_G.FastMode = value
end)
...
_G.FastModeD = "Smooth"
Setting:AddDropdown("เลือกความเร็วในการตี",SFast,function(value)
	_G.FastModeD = value
end)
...
coroutine.wrap(function()
	while task.wait(.1) do
		local ac = CombatFrameworkR.activeController
		if ac and ac.equipped then
			if FastAttack and _G.FastAttack and _G.FastMode == "ExTra" then
				AttackNoCD()
				if _G.FastModeD == "Normal" then
					if tick() - cooldownfastattack > .9 then wait(.1) cooldownfastattack = tick() end
				elseif _G.FastModeD == "Extra" then
...
Setting:AddToggle("ออโต้คริก",false,function(value)
_G.AutoClick = value
end)
...
elseif _G.WhiteScreen == false then
    ...
    Setting:AddSeperator("Setting Farm Mode")
    ...
    Mirragecheck:Set('🏝️: เกาะลับเกิดเเล้ว')
    else
      Mirragecheck:Set('❌: เกาะลับยังไม่เกิด ' )end
            end
        end)
end)
Mirragecheck = Mlk:AddLabel("")
Mlk:AddToggle("ออโต้บินไปเกาะลับ",_G.AutoMysticIsland,function(value)
    ...
    Mlk:AddToggle("ออโต้w",AutoW,function(W)
    AutoW = W
    end)
    spawn(function()
    while wait() do
    ...
    Mlk:AddToggle("Auto Summon  Mirage Island",_G.dao,function(state)
    if state then
        _G.dao = true
    else
        _G.dao = false
...
Mlk:AddToggle("Teleport Advanced Fruit Dealer",_G.TPNPC,function(value)
             _G.Miragenpc = value
...
Mlk:AddButton("บินไปหาคนขายผล", function()
                TweenNpc()
                end)
...
Mlk:AddToggle("ออโต้ไปเก็บเกียร์",_G.TweenMGear,function(value)
_G.TweenMGear = value
				...
				if game.Players.LocalPlayer.Character:FindFirstChild("Superhuman") or game.Players.LocalPlayer.Backpack:FindFirstChild("Superhuman") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Death Step") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Death Step") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Fishman Karate") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Fishman Karate") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Sharkman Karate") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Sharkman Karate") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electro") or game.Players.LocalPlayer.Character:FindFirstChild("Electro") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electric Claw") or game.Players.LocalPlayer.Character:FindFirstChild("Electric Claw") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Talon") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Talon") or game.Players.LocalPlayer.Character:FindFirstChild("Godhuman") or game.Players.LocalPlayer.Backpack:FindFirstChild("Godhuman") then
					if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySuperhuman",true) == 1 then
						...
						game.StarterGui:SetCore("SendNotification", {
							...
							Icon = "http://www.roblox.com/asset/?id=l",
							Duration = 2.5
						})
					end
...
M:AddToggle("Auto Tushita", _G.Autotushita,function(value)
    ...
    Shop:AddSeperator("อีเว้นท์ทะเล⛵")
    
    Shop:AddToggle("Auto Drive Boat Sea Event", _G.DomadicAutoDriveBoat,function(value)
    ...
    Shop:AddToggle("Auto Farm Terrorshark", _G.AutoTerrorshark,function(value)
    ...
    Shop:AddToggle("Auto Farm Piranha",_G.farmpiranya,function(value)
    _G.farmpiranya = value
    StopTween(_G.farmpiranya)
    end)
    
    Shop:AddToggle("Auto Fish Crew Member",_G.Fish_Crew_Member,function(value)
    _G.Fish_Crew_Member = value
    StopTween(_G.Fish_Crew_Member)
    end)
    
    Shop:AddToggle("Auto Terrorshark Hop", _G.AutoTerrorsharkhop,function(value)
    ...
    Shop:AddToggle("Auto Raid Ship",_G.KillGhostShip,function(value)
    ...
    Shop:AddToggle("Auto Ghost Ship",_G.bjirFishBoat,function(value)
    ...
    pcall(function()
        while wait() do
            if game.Workspace._WorldOrigin.Locations:FindFirstChild('Kitsunen Island') then
                FaiFaoKai:Set('🦊: เกาะเกิดเเล้วว')
            else
                FaiFaoKai:Set('🔴: เกายังไม่เกิด')
            end
        end
    end)
end)
...
FrozenIsland = M:AddLabel("")
    ...
    Shop:AddSeperator("คิสึเนะ🦊")
        
    FaiFaoKai = Shop:AddLabel("")
    
    
    Shop:AddToggle("บินไปเกาะคิสึเนะ",_G.AutoFKitsune,function(value)
    _G.AutoFKitsune = value
    StopTween(_G.AutoFKitsune)
    end)
    
    Shop:AddToggle("เก็บลูกไฟ",_G.AutoAzuerEmber,function(value)
    ...
    Shop:AddToggle("คุยกับหิน",_G.KisuneWarn,function(value)
    _G.KisuneWarn = value
    end)
...
notification.Volume = 5 --ระวังหูแตก
    ...
    Shop:AddSeperator("รออัพเดทต่อๆไป")
...
P:AddButton("Set Position Spawn",function()
    ...
    spawn(function()
        ...
        R:AddToggle("ออโต้ย้ายเกาะในดัน",_G.Auto_Dungeon,function(value)
...
spawn(function()
    ...
    R:AddToggle("ออโต้กดทำผลตื่น",_G.Auto_Awakener,function(value)
...
spawn(function()
    ...
    R:AddDropdown("เลือกซือชิป",Raidslist,function(value)
        _G.SelectChip = value
    end)
    
    R:AddToggle("ออโต้เริ่มดัน",_G.AutoSelectDungeon,function(value)
    ...
    R:AddToggle("ออโต้ซื้อชิป",_G.AutoBuyChip,function(value)
    ...
    R:AddButton("ออโต้ซื้อชิป",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("RaidsNpc","Select",_G.SelectChip)
    end)
    
    R:AddToggle("ออโต้เริ่มดัน",_G.Auto_StartRaid,function(value)
    ...
    R:AddButton("ออโต้เริ่มดัน",function()
        if World2 then
            fireclickdetector(game:GetService("Workspace").Map.CircleIsland.RaidSummon2.Button.Main.ClickDetector)
        elseif World3 then
            fireclickdetector(game:GetService("Workspace").Map["Boat Castle"].RaidSummon2.Button.Main.ClickDetector)
    ...
    Main:AddSeperator("Misc KoKo Sword")
    
 Main:AddToggle("ออโต้ตีบอสลอว์ ", _G.AutoOderSword,function(value)
     _G.AutoOderSword = value
    StopTween( _G.AutoOderSword)
    end)
    
    Main:AddToggle("ออโต้ตีบอสลอว์ Hop)", _G.AutoOderSwordHop,function(value)
    ...
    Main:AddButton("ซื้อชิปบอสลอว์",function()
    local args = {
       [1] = "BlackbeardReward",
       [2] = "Microchip",
       [3] = "2"
    ...
    Main:AddButton("เริ่มดันบอสลอว์",function()
        if World2 then
...
S:AddButton("Random Race (Use 3K Fragments)", function()
    ...
    D:AddDropdown("เลือกผลที่จะกิน",Table_DevilFruitSniper,function(value)
        _G.SelectFruitEat = value
    end)
    
    D:AddToggle("ออโต้กินผลปีศาจ",_G.AutoEatFruit,function(value)
    ...
    D:AddToggle("ออโต้กินผลปีศาจ Hop",_G.AutoEatFruitHop,function(value)
    ...
    D:AddToggle("ออโต้สุ่มผล",_G.Random_Auto,function(value)
        _G.Random_Auto = value
    end)
    ...
    D:AddToggle("ออโต้ทิ้งผล",_G.DropFruit,function(value)
        _G.DropFruit = value
    end)
    ...
    D:AddToggle("ออโต้เก็บผล",_G.AutoStoreFruit,function(value)
        _G.AutoStoreFruit = value
    end)
...
spawn(function()
    ...
    D:AddToggle("ออโต้ดึงผล",_G.Grabfruit,function(value)
    _G.Grabfruit = value
    end)
    spawn(function()
			while wait(.1) do
