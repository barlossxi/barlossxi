...
Main:AddToggle("รวมมอน",true,function(Mag)
    _G.BringMonster = Mag
    end)
    spawn(function()
        while task.wait() do
...
_G.BringMode = "Normal"
Main:AddDropdown("เลือกโหมดรวมมอน", Bring,function(value)
    _G.BringMode = value
end)
spawn(function()
    while wait(.1) do
...
spawn(function()
    ...
    Main:AddToggle("ออโต้ตีเร็ว",true,function(value)
        _G.FastAttack = value
    end)      
...
_G.FastMode = "Normal"
Main:AddDropdown("เลือกโหมดตีเร็ว",fast,function(value)
	_G.FastMode = value
end)
...
_G.FastModeD = "Smooth"
Main:AddDropdown("เลือกความเร็วในการตี",SFast,function(value)
	_G.FastModeD = value
end)
...
Main:AddToggle("ออโต้คริก",false,function(value)
_G.AutoClick = value
end)
