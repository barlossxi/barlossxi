...
spawn(function()
    ...
    Main:AddToggle("ออโต้ฟามคาตาคุริ",true,function(value)
...
Main:AddToggle("ออโต้ ฮาคิ",true,function(value)
_G.AUTOHAKI = value
end)
spawn(function()
    while wait(.1) do
...
Mlk:AddToggle("Auto Mystic Island",_G.AutoMysticIsland,function(value)
    ...
    Mlk:AddToggle("Auto Drive",AutoW,function(W)
    AutoW = W
    end)
    spawn(function()
    while wait() do
...
Mlk:AddButton("Teleport Advanced Fruit Dealer", function()
                TweenNpc()
                end)
...
Mlk:AddToggle("Tween Gear",_G.TweenMGear,function(value)
_G.TweenMGear = value
