_G.Color = Color3.fromRGB(3, 252, 244)
_G.Logo = 16341514086
...
local ZZ = tab1:CraftPage('บลาๆ',1)
local ZX = tab1:CraftPage('บลาๆ',2)
local tab2 = Win:CraftTab('อีเว้นท์ทะเล')
local ZC = tab2:CraftPage('บลาๆ',1)
local ZV = tab2:CraftPage('บลาๆ',2)
local tab3 = Win:CraftTab('ไอเท็ม')
local ZB = tab3:CraftPage('บลาๆ',1)
local ZN = tab3:CraftPage('บลาๆ',2)
local tab4 = Win:CraftTab('เผ่าวี4')
local ZM = tab4:CraftPage('บลาๆ',1)
local ZA = tab4:CraftPage('บลาๆ',2)
local tab5 = Win:CraftTab('อัพค่าพลัง')
local ZQ = tab5:CraftPage('บลาๆ',1)
local ZW = tab5:CraftPage('บลาๆ',2)
local tab6 = Win:CraftTab('ผู้เล่น')
local ZE = tab6:CraftPage('บลาๆ',1)
local ZR = tab6:CraftPage('บลาๆ',2)
local tab7 = Win:CraftTab('วาป')
local ZT = tab7:CraftPage('บลาๆ',1)
local ZY = tab7:CraftPage('บลาๆ',2)
local tab8 = Win:CraftTab('ลงดัน')
local ZU = tab8:CraftPage('บลาๆ',1)
local ZI = tab8:CraftPage('บลาๆ',2)
local tab9 = Win:CraftTab('ผลปีศาจ')
local ZO = tab9:CraftPage('บลาๆ',1)
local ZP = tab9:CraftPage('บลาๆ',2)
local tab10 = Win:CraftTab('อื่น')
local ZS = tab10:CraftPage('บลาๆ',1)
local ZD = tab10:CraftPage('บลาๆ',2)


    


ZX:Toggle("Auto SetSpawn Point [open it If you use Bypass Tp]",true,function(value)
    _G.Set = value
end)
...
ZX:Dropdown("Select Weapon",WeaponList,function(value)
...
FarmMode = "Normal"
ZX:Dropdown("Farm Mode", ListF,function(value)
    FarmMode = value
end)
   
    
    ZZ:Toggle("Auto Farm Level",_G.AutoFarm,function(value)
        _G.AutoFarm = value
...
if World1 then
    ZX:Toggle("Auto Farm Fast (Farm Lv.1-300)",_G.AutoFarmFast,function(value)
        _G.Farmfast = value
...
ZX:Toggle("Auto Kaitan",false,function(value)
       _G.AutoFarm = value
...
ZX:Toggle("Auto Farm Chest",false,function(value)
 AutoFarmChest = value
...
ZX:Toggle("Auto Farm Chest Mirage island",false,function(value)
...
ZX:Toggle("Auto Chest Bypass",false,function(vu)
	_G.ChestBypass = vu
end)
