...
do local GUI = game.CoreGui:FindFirstChild("SOMEXHUB");if GUI then GUI:Destroy();end;if _G.Color == nil then
    _G.Color = Color3.fromRGB(252, 3, 3)
   end 
end
...
local LogoHub = Instance.new("ImageLabel")
    ...
    LogoHub.Image = "http://www.roblox.com/asset/?id="..tostring(ok)
...
if World1 then
    Main:AddToggle("ฟามเวล1-300ค่ตเร็ว",_G.AutoFarmFast,function(value)
        _G.Farmfast = value
...
FarmMode = "Normal"
Main:AddDropdown("เลือกโหมดฟาม", ListF,function(value)
    FarmMode = value
end)
...
Main:AddToggle("ออโต้ซื้อดาบทั้งหมด",false,function(value)
       _G.AutoFarm = value
...
Main:AddDropdown("เลือกมอน",tableMon,function(vu)
    _G.SelectMob = vu
end)
    
    Main:AddToggle("ออโต้ฟามมอน",_G.AutoFarmMob,function(value)
   ...
   Main:AddToggle("ออโต้ฟามจุดใกล้ที่สุด ",_G.AutoFarmNearest,function(value)
...
Main:AddToggle("เชฟจุดเกิดBypass",true,function(value)
    _G.Set = value
end)
