local ui =  game:GetService("CoreGui"):FindFirstChild("redui") if ui then ui:Destroy() end
	...
	function create:Win(text)
		...
		MainSceen.BackgroundColor3 = Color3.fromRGB(219, 7, 24)
		...
		ClickFrame.BackgroundColor3 = Color3.fromRGB(219, 7, 24)
		...
		NameReal.BackgroundColor3 = Color3.fromRGB(219, 7, 24)
		...
		MainSceen2.BackgroundColor3 = Color3.fromRGB(219, 7, 24)
