local ui =  game:GetService("CoreGui"):FindFirstChild("redui") if ui then ui:Destroy() end
	...
	function create:Win(text)
		...
		MainSceen.BackgroundColor3 = Color3.fromRGB(252, 3, 3)  --ขอบui
		...
		ClickFrame.BackgroundColor3 = Color3.fromRGB(252, 3, 3)    --ขอบui
		...
		ScolTapBarFrame.BackgroundColor3 = Color3.fromRGB(255,255,255)  --กลางui
		...
		ScrollingFrame_Menubar.BackgroundColor3 = Color3.fromRGB(255, 255, 255) --กลางui
		...
		NotiFrame.BackgroundColor3 = Color3.fromRGB(242, 235, 235). ---ชื่อมั้ง
		...
		function create:Notifile(titel,text,delays)
			...
			TitleFrame.BackgroundColor3 = Color3.fromRGB(0, 0, 0)  --2อันเเหละ
