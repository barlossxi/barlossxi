local ui =  game:GetService("CoreGui"):FindFirstChild("redui") if ui then ui:Destroy() end
	...
	function create:Win(text)
		...
		MainSceen.BackgroundColor3 = Color3.fromRGB(209, 21, 21)
		...
		ClickFrame.BackgroundColor3 = Color3.fromRGB(209, 21, 21)
		...
		NameReal.BackgroundColor3 = Color3.fromRGB(46, 41, 41)
		...
		MainSceen2.BackgroundColor3 = Color3.fromRGB(46, 41, 41)
		...
		ScrollingFrame_Menubar.BackgroundColor3 = Color3.fromRGB(46, 41, 41)
		...
		ScrollingFrame_Menubar.ScrollBarImageColor3 = Color3.fromRGB(46, 41, 41)
